                ...
                <div class="row" style="justify-items: end; text-align: end;">
                    <div class="col">
                        <div class="btn-group" role="group" aria-label="Basic example">
                            ...
                            <a href="{{ route('vacancy-company-apply') }}"><button type="button"
                                    class="btn btn-secondary me-3">Sebelumnya</button></a>
                            <a href="{{ route('vacancy-company-apply-end') }}"><button type="button"
