                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <input type="hidden" name="bukti_path" value="">
                            ...
                            <div class="form mb-3">
                                <div class="form">
                                    <div class="deskripsi">
                                        <label for="" style="font-weight: bold;">Deskripsi</label>
                                        <textarea spellcheck="false" placeholder="Masukkan Deskripsi" name="description-info" required value=""></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-12 p-0">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="container">
                                            <input type="file" id="file-info" accept="image/*" name="poster"
                                                style="display: none" value="">
                                            <div class="img-area-info" data-img="">
                                                <i class='bx bxs-cloud-upload icon'></i>
                                                <h3>Unggah Poster</h3>
                                                <p>Pastikan file kurang dari <span>2MB</span></p>
                                            </div>
                                            <button type="button" class="select-image-info"> Pilih Poster</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
