...
@section('content')
    ...
    <script>
        $(function() {
            ...
            new ApexCharts(document.querySelector("#news-active"), e).render();
            e = {
                series: [{
            ...
            new ApexCharts(document.querySelector("#news-nonactive"), e).render();
            e = {
                series: [{
                    name: "news Accept",
