      <footer id="footer" class="footer">
              ...
              <div class="container">
                  <div class="row justify-content-center">
                      <div class="col-lg-12 text-center">
                          <h4>Ikuti Kami</h4>
                          <p>Masukkan Email Anda dan Ikuti Berita Terkini</p>
                      </div>
                      <div class="col-lg-6">
          ...
          <div class="container">
              <div class="copyright">
                  &copy; Copyright <strong><span>CDC Online Politeknik Negeri Jember</span></strong>. All Rights
                  Reserved
              </div>
              <div class="credits">
                  Part of <a href="https://jtinova.polije.ac.id/">JTINova Teaching Factory Politeknik Negeri Jember</a>
              </div>
          </div>
      </footer><!-- End Footer -->
